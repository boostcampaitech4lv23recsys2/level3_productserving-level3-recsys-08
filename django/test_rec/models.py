...
class TmpUser(models.Model):
    ...
    prefer_movie_id = models.CharField(max_length=10000, null=True, blank=True) #int로 안한 이유는 리스트로 담기 위함이다.
    recommended_character_id = models.CharField(max_length=10000, null=True, blank=True)
